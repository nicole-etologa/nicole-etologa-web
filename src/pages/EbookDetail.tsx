...
import { ebookJsonLd } from '../components/seo/Ebook.schema';
      ...
      <div className="min-h-screen flex flex-col bg-[#e9e9f7] dark:bg-[#15141d]">
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="space-y-8">
              <div className="bg-white dark:bg-[#211f2c] rounded-lg shadow-lg dark:shadow-black/25 p-5">
                <div className="flex items-start gap-4">
                  <div className="bg-[#e682b6] p-4 rounded-lg">
                    <Book className="w-8 h-8 text-white" />
                  </div>
                  <div className="flex justify-between items-start">
                    <h2 className="text-xl sm:text-2xl font-bold text-[#8c8cdc] dark:text-[#b8b8f0] mb-2">
                      {ebook.title}
                    </h2>
                ...
                <div className='flex flex-col'>
                  <p className="text-gray-600 dark:text-gray-300 py-3">{ebook.description}</p>
                  <p className="text-gray-600 dark:text-gray-300 py-3">{ebook.fullDescription}</p>
                </div>
                <div className="mb-6">
                  <h3 className="text-lg font-semibold text-[#8c8cdc] dark:text-[#b8b8f0] my-2">Contenido:</h3>
